...
<script type="text/javascript" src="{{ asset('js/azure2/authConfig.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/azure2/graphConfig.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/azure2/ui.js') }}"></script>
